...
public class tcas3 {
	 ...
	 int alt_sep_test()
	{
	    ...
	    intent_not_known = Two_of_Three_Reports_Valid || Other_RAC == NO_INTENT;//v3:intent_not_known = Two_of_Three_Reports_Valid && Other_RAC == NO_INTENT;
		...
		need_downward_RA = Non_Crossing_Biased_Descend() ;//v32&& Own_Above_Threat();//v32
